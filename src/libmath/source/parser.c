...
#endif
#define RealMathParseARG_SDECL  parse::parse_state* state ;
#define RealMathParseARG_PDECL , parse::parse_state* state 
#define RealMathParseARG_PARAM ,state 
#define RealMathParseARG_FETCH  parse::parse_state* state =yypParser->state ;
...
/********** Begin reduce actions **********************************************/
      default:
      /* (0) doc ::= compound_stmt */ yytestcase(yyruleno==0);
